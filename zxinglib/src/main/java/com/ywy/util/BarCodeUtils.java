...
public class BarCodeUtils {
    ...
    public static Bitmap encodeQRCode(String content, int size) {
        return encodeQRCode(content, size, Color.BLACK, Color.WHITE, null);
    }
     ...
     */
    public static Bitmap encodeQRCode(String content, int size, int foregroundColor) {
        return encodeQRCode(content, size, foregroundColor, Color.WHITE, null);
    }
     ...
     */
    public static Bitmap encodeQRCode(String content, int size, int foregroundColor, Bitmap logo) {
        return encodeQRCode(content, size, foregroundColor, Color.WHITE, logo);
    }
